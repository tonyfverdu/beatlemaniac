...
import "../../../../sass/componentsSass/Player/PlayerMusic/ProgressCircle.scss"
...
const Circle = ({ color, percentage, size, strokeWidth }) => {
  ...
  return (
    <circle r={radius} cx="50%" cy="50%" fill="transparent" stroke={strokePct !== circ ? color : ""} strokeWidth={strokeWidth}
      strokeDasharray={circ} strokeDashoffset={percentage ? strokePct : 0} strokeLinecap="round"
    >
    </circle>
  )
}
